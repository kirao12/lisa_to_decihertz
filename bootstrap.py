...
def bootstrapped_kde(variable, weights, ax, bw_adjust=None, normalisation=1,
                     lower_bound=None, upper_bound=None,
                     bootstraps=200, x_min=None, x_max=None, x_count=200,
    ...
    for i in range(bootstraps):
        ...
        kde = MirroredKDE(
            np.asarray(variable)[boot_index],
            weights=np.asarray(weights)[boot_index],
